...
first_start = int(first_num / 1000)
second_start = int((first_num / 100) % 10)
third_start = int((first_num / 10) % 10)
fourth_start = int(first_num % 10)

first_end = int(second_num / 1000)
second_end = int((second_num / 100) % 10)
third_end = int((second_num / 10) % 10)
fourth_end = int(second_num % 10)
